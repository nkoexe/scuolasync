...
CLIENT_ID = '985141409906-s8ghsaeeqko93ngldqv8l728oidab0k5.apps.googleusercontent.com'
CLIENT_SECRET = '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'

DATA = {
    'response_type': "code",  # this tells the auth server that we are invoking authorization workflow
    'redirect_uri': "http://localhost:5000/loginfatto",  # redirect URI https://console.developers.google.com/apis/credentials
